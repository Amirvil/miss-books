export function Home() {
    return <section className="home">
        <div className="welcome-container">
            ...
            <p className="welcome-text">
                Whether you’re searching for the soul-stirring rhythms of contemporary Hebrew poetry,
                a rare international art monograph, or simply a quiet corner to lose yourself
                in a new story, you’ve found your place.
            </p>
            <p className="welcome-text">
